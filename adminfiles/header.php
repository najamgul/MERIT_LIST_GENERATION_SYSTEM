...
<nav class="navbar navbar-expand-lg navbar-light justify-content-center border border-success rounded-4">
    <div class="row">
    <div class="col-2 mt-3">
        <a href="../index.php">
    <button class="btn btn-lg border border-1 border-primary bg-info bg-opacity-10"><i class="bi bi-house-door"></i>HOME</button></a>
    </div>
    <div class="col-8">
