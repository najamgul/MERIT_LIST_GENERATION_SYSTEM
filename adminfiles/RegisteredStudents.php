...
$sql = "SELECT * FROM student_data INNER JOIN detailstd ON student_data.applicationid = detailstd.applicationid
ORDER BY detailstd.percent DESC;";
...
<body>
    ...
    <div class="container">
        ...
        <a href="admindashboard.php" class="btn btn-primary ml-5 pr-1">BACK TO DASHBOARD <i class="fa fa-dashboard" aria-hidden="true"></i></a> 
    </div>
